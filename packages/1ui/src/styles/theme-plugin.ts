...
export const themePlugin = plugin(
  ...
  function ({ addBase, addUtilities }) {
    ...
    Object.entries(themes).forEach(([key, value]) => {
      addBase({
        [`[data-theme="${key}"]`]: {
          '--background': value.background.DEFAULT,
          '--foreground': value.foreground.DEFAULT,
          '--card': value.card.DEFAULT,
          '--card-foreground': value.cardForeground.DEFAULT,
          '--popover': value.popover.DEFAULT,
          '--popover-foreground': value.popoverForeground.DEFAULT,
          '--primary': value.primary.DEFAULT,
          '--primary-foreground': value.primaryForeground.DEFAULT,
          '--secondary': value.secondary.DEFAULT,
          '--secondary-foreground': value.secondaryForeground.DEFAULT,
          '--muted': value.muted.DEFAULT,
          '--muted-foreground': value.mutedForeground.DEFAULT,
          '--accent': value.accent.DEFAULT,
          '--accent-foreground': value.accentForeground.DEFAULT,
          '--destructive': value.destructive.DEFAULT,
          '--destructive-foreground': value.destructiveForeground.DEFAULT,
          '--border': value.border.DEFAULT,
          '--input': value.input.DEFAULT,
          '--ring': value.ring.DEFAULT,
          '--radius': value.radius,
          '--success': value.success.DEFAULT,
          '--success-foreground': value.successForeground.DEFAULT,
          '--warning': value.warning.DEFAULT,
          '--warning-foreground': value.warningForeground.DEFAULT,
          '--for': value.for.DEFAULT,
          '--for-foreground': value.forForeground.DEFAULT,
          '--against': value.against.DEFAULT,
          '--against-foreground': value.againstForeground.DEFAULT,
          '--social': value.social.DEFAULT,
          '--social-foreground': value.socialForeground.DEFAULT,
        },
      })
    })
