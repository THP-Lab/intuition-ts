import{j as s}from"./jsx-runtime-Cw0GR0a5.js";import{l as a,m as l}from"./IdentityInput-mw73YtJF.js";const c={title:"Components/ClaimStakeCard",component:a,argTypes:{currency:{description:"Currency type",options:Object.values(l),table:{type:{summary:"string"}},control:"select"}}},t={args:{currency:"ETH",totalTVL:4.928,tvlAgainst:.567,tvlFor:3.643,amountAgainst:39,amountFor:124,disableAgainstBtn:!1,disableForBtn:!1,onAgainstBtnClick:()=>console.log("Against button clicked!"),onForBtnClick:()=>console.log("For button clicked!")},render:r=>s.jsx(a,{...r})};var n,e,o;t.parameters={...t.parameters,docs:{...(n=t.parameters)==null?void 0:n.docs,source:{originalSource:`{
  args: {
    currency: 'ETH',
    totalTVL: 4.928,
    tvlAgainst: 0.567,
