import{j as e}from"./jsx-runtime-Cw0GR0a5.js";import{bx as c,by as d,bz as s,bA as p,bB as u}from"./TransactionStatusIndicator-B45suF28.js";const l=()=>e.jsx(e.Fragment,{});l.__docgenInfo={description:"",methods:[],displayName:"Indicators"};const y={title:"Components/Indicators",component:l},n=({children:t})=>e.jsx("div",{className:"flex flex-col justify-center items-center gap-2 border border-solid  border-white/50 rounded-md p-2.5",children:t}),i={render:()=>e.jsxs("div",{className:"w-[900px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4",children:[e.jsxs(n,{children:[e.jsx("p",{children:"MonetaryValue"}),e.jsx(c,{value:.345,currency:"ETH"})]}),e.jsxs(n,{children:[e.jsx("p",{children:"FeesAccrued"}),e.jsx(d,{value:.005,currency:"ETH"})]}),e.jsxs(n,{children:[e.jsx("p",{children:"PositionValueDisplay - claimFor"}),e.jsx(s,{value:.345,position:"for",feesAccrued:.005})]}),e.jsxs(n,{children:[e.jsx("p",{children:"PositionValueDisplay - claimAgainst"}),e.jsx(s,{value:.5,position:"against",feesAccrued:.01,currency:"ETH"})]}),e.jsxs(n,{children:[e.jsx("p",{children:"PositionValueDisplay - identity"}),e.jsx(s,{value:.789,position:"identity",feesAccrued:.02})]}),e.jsxs(n,{children:[e.jsx("p",{children:"ClaimValueDisplay"}),e.jsx(p,{tvl:.345,currency:"ETH",claimsFor:230,claimsAgainst:125})]}),e.jsxs(n,{children:[e.jsx("p",{children:"IdentityValueDisplay"}),e.jsx(u,{value:.345,currency:"ETH",followers:230})]})]})};var a,r,o;i.parameters={...i.parameters,docs:{...(a=i.parameters)==null?void 0:a.docs,source:{originalSource:`{
  render: () => <div className="w-[900px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <Container>
        ...
        <PositionValueDisplay value={0.345} position="for" feesAccrued={0.005} />
      </Container>
      <Container>
        <p>PositionValueDisplay - claimAgainst</p>
        <PositionValueDisplay value={0.5} position="against" feesAccrued={0.01} currency="ETH" />
      </Container>
      <Container>
