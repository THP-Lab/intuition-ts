...
`,e.jsx(u,{})]})}function j(t={}){const{wrapper:o}={...s(),...t.components};return o?e.jsx(o,{...t,children:e.jsx(n,{...t})}):n(t)}const L={parameters:{layout:"centered",actions:{argTypesRegex:"^on[A-Z].*"},controls:{matchers:{color:/(background|color)$/i,date:/Date$/i}},backgrounds:{default:"dark",values:[{name:"dark",value:r.black.base},{name:"light",value:r.white.base}]},options:{storySort:{method:"alphabetical",order:["Documentation","Components","Styles"]}},docs:{page:j}}},N={theme:{name:"Theme",description:"Global theme for components",defaultValue:"dark",toolbar:{icon:"paintbrush",items:["dark","light"].map(t=>({value:t,title:`${t} theme`})),showName:!0}}},P=[a];export{P as decorators,L as default,N as globalTypes};
